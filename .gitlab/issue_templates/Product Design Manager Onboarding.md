...
* [ ] [Learn how we communicate as a company](https://handbook.gitlab.com/handbook/communication/). We use asynchronous communication as a start and are as open as we can be by communicating through public issues, chat channels, and placing an emphasis on ensuring that conclusions of offline conversations are written down.
* [ ] When setting up your home office, get advice and guidance about what you might need and what you can expense by checking out the [spending company money page](https://handbook.gitlab.com/handbook/finance/spending-company-money/).
...
* [ ] Read through the whole [UX handbook](https://handbook.gitlab.com/handbook/product/ux/) section, please! Consider this your first team task, understanding the Mission, Vision, and how work is executed within the department. If you find any typos or items that could be made clearer, please consider submitting a merge request.
