...
- [ ] Once you have access to the GitLab organization in Figma, browse some of the teams and projects to see how we design in Figma.
...
- In Figma, click the ⭑ button to add a project to your favorites for easy access (for example, your stage group project).
