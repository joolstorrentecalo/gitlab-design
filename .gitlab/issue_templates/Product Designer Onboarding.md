...
- [ ] Learn how to use GDK to review code by asking to participate in an MR review with another Product Designer in the `#ux-coworking` channel. Consider including your timezone in the message so the session can be synchronous.
