...
1. [ ] Review the current experience, noting where you expect a user's high and low points to based on [NN/g's 10 Usability Heuristics for User Interface Design](https://www.nngroup.com/articles/ten-usability-heuristics/). Capture the screens and jot down observations.
