	...
	},
	{
		...
		'contextual' : [
			{ 
				...
				'second_level_rows': [
# 					{ 
# 						'name' : 'settings_general', 'text' : 'General Settings', 
# 						'pages' : [
# 							{
# 								'image' : 'images/project-settings.png',
# 								'height' : 2645,
...
# Main
environmentController = new EnvironmentController(gitlab_tree, sketch.top_bar.height)
