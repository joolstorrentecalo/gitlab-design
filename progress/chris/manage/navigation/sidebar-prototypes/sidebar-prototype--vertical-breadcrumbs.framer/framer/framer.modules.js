...
exports.EnvironmentController = (function() {
  function EnvironmentController(info, topBarHeight) {
    ...
    var breadcrumbNavigationController, breadcrumbNavigationInfo, breadcrumbRow, breadcrumbSection, breadcrumbSectionContent, breadcrumbSectionInfo, breadcrumbSectionRowsInfo, contextualNavigationController, contextualNavigationInfo, dropdown, dropdownRow, environment, environmentInfo, firstLevelContentArea, firstLevelHotspot, firstLevelPagesInfo, firstLevelRow, firstLevelRowInfo, firstLevelSection, firstLevelSectionInfo, hotspotInfo, i, j, k, l, len, len1, len2, len3, len4, m, n, name, o, p, pageInfo, q, r, ref, ref1, ref2, ref3, ref4, ref5, rowInfo, s, secondLevelContentArea, secondLevelHotspot, secondLevelPagesInfo, secondLevelRow, secondLevelRowInfo, secondLevelRowsInfo, secondLevelSection, sidebar;
    this.environments = [];
    ...
    for (k = 0, len = info.length; k < len; k++) {
      ...
      for (i = l = 0, ref = breadcrumbNavigationInfo.length - 1; l <= ref; i = l += 1) {
        breadcrumbSectionInfo = breadcrumbNavigationInfo[i];
        breadcrumbSection = new BreadcrumbNavigationSection(breadcrumbSectionInfo['name'], breadcrumbSectionInfo['text'], breadcrumbNavigationController, i);
        breadcrumbSectionContent = new BreadcrumbNavigationSectionContent(breadcrumbSectionInfo['name'], breadcrumbSection, breadcrumbSectionInfo['rows'].length);
        breadcrumbSectionRowsInfo = breadcrumbSectionInfo['rows'];
        for (j = m = 0, ref1 = breadcrumbSectionRowsInfo.length - 1; m <= ref1; j = m += 1) {
          rowInfo = breadcrumbSectionRowsInfo[j];
          breadcrumbRow = new BreadcrumbNavigationRow(rowInfo['name'], rowInfo['text'], rowInfo['image'], breadcrumbSectionContent, rowInfo['environment_link'], j);
      ...
      for (i = n = 0, ref2 = contextualNavigationInfo.length - 1; n <= ref2; i = n += 1) {
        ...
        if (firstLevelPagesInfo.length) {
          for (o = 0, len1 = firstLevelPagesInfo.length; o < len1; o++) {
            pageInfo = firstLevelPagesInfo[o];
        ...
        for (j = q = 0, ref4 = secondLevelRowsInfo.length - 1; q <= ref4; j = q += 1) {
          ...
          if (secondLevelPagesInfo.length) {
            for (r = 0, len3 = secondLevelPagesInfo.length; r < len3; r++) {
              pageInfo = secondLevelPagesInfo[r];
              secondLevelContentArea = new ContentArea(pageInfo['name'], pageInfo['image'], pageInfo['height']);
              ref5 = pageInfo['hotspots'];
...
exports.Sidebar = (function() {
  function Sidebar(name, enviroment, topBarHeight) {
    ...
    this.setBreadcrumbNavigationController = bind(this.setBreadcrumbNavigationController, this);
    this.switchStateDefault = bind(this.switchStateDefault, this);
    this.switchStateVisible = bind(this.switchStateVisible, this);
    this.getLayer = bind(this.getLayer, this);
    ...
    this.getContextualNavigationController = bind(this.getContextualNavigationController, this);
    this.getBreadcrumbNavigationController = bind(this.getBreadcrumbNavigationController, this);
    this.breadcrumbNavigationController = null;
  ...
  Sidebar.prototype.getBreadcrumbNavigationController = function() {
    return this.breadcrumbNavigationController;
  };
  ...
  Sidebar.prototype.setBreadcrumbNavigationController = function(setBreadcrumbNavigationController) {
    return this.breadcrumbNavigationController = setBreadcrumbNavigationController;
  };
  ...
  Sidebar.prototype.recalculatePositions = function() {
    ...
    breadcrumbs_height = this.breadcrumbNavigationController.recalculateVerticalBreadcrumbsPositions();
    this.contextualNavigationController.getLayer().y = breadcrumbs_height;
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
