...
whuty = sketch.tab1_build_tooltip.screenFrame

# tab1 mpg tooltips
sketch.tab1_build_stage.onMouseOver ->
	sketch.tab1_build_tooltip.visible = true
	sketch.tab1_build_tooltip.parent = sketch.tab_tabs
	sketch.tab1_mpg.removeChild(sketch.tab1_build_tooltip)
	sketch.tab1_build_tooltip.screenFrame = whuty
