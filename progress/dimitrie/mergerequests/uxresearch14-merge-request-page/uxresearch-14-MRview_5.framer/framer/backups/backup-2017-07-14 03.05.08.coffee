...
# 		print sketch.mrviewcontent.height
		...
		if sketch.merge_status.children[2].states.current.name == "focus"
			...
			sketch.mini_status_codequality.x = sketch.mini_status_codequality.orgX
			sketch.mini_status_mergability.x = sketch.mini_status_mergability.orgX
			sketch.mr_underline.width = sketch.mr_underline.orgWidth
			sketch.discussion.animate
				x: sketch.discussion.orgX
			sketch.commits.animate
				x: sketch.commits.orgX
