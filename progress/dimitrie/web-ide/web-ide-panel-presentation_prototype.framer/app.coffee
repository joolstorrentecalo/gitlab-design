...
# Import file "web-ide-panel-presentation_prototype"
sketch = Framer.Importer.load("imported/web-ide-panel-presentation_prototype@2x", scale: 1)
...
# Hide and Show section function
slide = (layer, visible = true, transition = true, desiredheight) ->
	layer.clip = true
	originallayerheight = layer.height
	if transition is true
		layer.states =
...
# Button
hideshow(sketch.button_review, true, false)
hideshow(sketch.button_edit, false, false)

sketch.button_review.onClick ->
	sketch.button_review.animate("state_hide")
	sketch.button_edit.animate("state_show")

sketch.button_edit.onClick ->
	sketch.button_edit.animate("state_hide")
	sketch.button_review.animate("state_show")

sketch.review.y = 840

hideshow(sketch.editor_edit, true, false)
hideshow(sketch.editor_diff, false, false)

sketch.button_review.onClick ->
	sketch.editor_edit.animate("state_hide")
	sketch.editor_diff.animate("state_show")

sketch.button_edit.onClick ->
	sketch.editor_diff.animate("state_hide")
	sketch.editor_edit.animate("state_show")

slide(sketch.unstaged_changes, true, true, 46)
sketch.unstaged_changes.animate("state_hide")

sketch.button_review.onClick ->
	sketch.unstaged_changes.animate("state_show")
	sketch.review.animate
		y: 104
...
constraint(sketch.staged_changes,sketch.unstaged_changes, 4)
